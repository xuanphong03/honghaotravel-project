...
export default function BannerTourDetail() {
  ...
  return (
    <div className="tourdetail-banner relative flex min-h-[20.93544rem] items-end max-md:ps-[1.25rem] md:min-h-[49.25rem]">
      ...
      <div
        ref={cont}
        className="tourdetail-banner-cont relative z-10 mx-auto w-[87.5rem] max-w-[87.5rem] translate-y-32 transform py-[7.25rem] opacity-0 max-md:hidden md:py-[2rem]"
      >
        <div className="top flex flex-col gap-3">
          <div className="top-time flex items-center gap-6">
            <div className="top-time-oclock flex items-center gap-1.5">
              ...
              <span className="body1-bold !text-greyscaletext-0 !font-bold">
                Intermediate
              </span>
            </div>
            <div className="top-time-letter">
              <ul className="sub1-regular !text-greyscaletext-5 list-disc text-ellipsis">
        ...
        <div className="mid mt-[1.56rem] flex gap-12">
          <div className="mid-special flex w-[19rem] flex-col gap-4">
            <div className="mid-special-top">
              <div className="mid-special-title flex items-center gap-1">
                ...
                <span className="sub1-medium !text-greyscaletext-10">
                  SPECIAL
                </span>
              </div>
              <div className="mid-special-hr mt-2 mb-3">
                ...
                >
                  <path
                    d="M1 1H273"
                    stroke="url(#paint0_linear_7546_14812)"
                    strokeLinecap="round"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_7546_14812"
                      x1="2.3399"
                      y1="1.49976"
                      x2="270.99"
                      y2="1.49976"
              ...
              <ul className="mid-special-list body2-bold !text-greyscaletext-0 ms-4 flex list-disc flex-col gap-[0.625rem] py-2">
          ...
          <div className="mid-accomodation flex w-[19rem] flex-col gap-4">
