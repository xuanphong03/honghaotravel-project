    ...
    <div className="container mx-auto">
      ...
      >
        {arrTest.map((_, index) => (
          <SwiperSlide
            key={index}
            className="swiper-slide swiper-slide-active flex h-fit w-full cursor-pointer"
          >
            <div className="relative flex space-x-[7.87rem]">
              ...
              <article className="scrollbar-popup-tour-detail tablet:overflow-hidden tablet:h-[10rem] 3xl:min-h-[20.875rem] 4xl:!min-h-[24.875rem] xlg:p-[2rem] xmd:p-[1rem] xlg:rounded-[0.75rem] relative mb-[2rem] max-h-[25rem] min-h-[17.875rem] flex-1 rounded-[1.5rem] border-[2px] border-transparent bg-[#F5F5F5] p-[1.88rem] transition-all duration-1000 ease-out lg:overflow-hidden xl:border-[3px] 2xl:min-h-[18.875rem]">
