...
const dataBreadcrumb = [{
    id: 1,
    icon:<svg xmlns="http://www.w3.org/2000/svg" className='w-4 h-4' viewBox="0 0 16 16" fill="none">
  ...
  {
    id: 2,
    icon:<svg xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
  <path d="M1 1L4 4L1 7" stroke="#C5C5C5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>,
    title:"Tour",
    url: "",
    classNameTitle:"body2-regular !text-greyscaletext-10"
