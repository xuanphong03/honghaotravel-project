...
export default function Footer() {
  return (
    <div className="footer relative z-50 mx-auto h-fit items-start overflow-x-hidden bg-white px-3 md:px-[5.96rem]">
      <div className="footer-bg-l Z-0 absolute top-8 -left-6 h-[20.89425rem] w-[58.1875rem] bg-[url(/images/footer/footer-mbg.png)] bg-no-repeat opacity-30 md:top-0 md:-left-7 md:h-[33.57038rem] md:w-[109.5rem] md:bg-cover md:bg-center"></div>
