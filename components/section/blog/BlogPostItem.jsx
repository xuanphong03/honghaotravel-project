...
export default function BlogPostItem({data}) {
  return (
    <article className='group col-span-2 sm:col-span-1 h-[15.3125rem] sm:h-[25.8rem] rounded-xl overflow-hidden relative flex flex-col justify-between p-8 hover:cursor-pointer'>
      ...
      <div className='post-btn !w-fit uppercase sub2-regular !text-greyscaletext-80-main max-sm:!px-[1.19rem] max-sm:!py-[0.62rem] '>{ data.tag}</div>
