...
export default function Share() {
  ...
  return (
      ...
      <div className='max-w-[87.5rem] mx-auto relative'>
        <div className='w-[12.39444rem] h-[12.39444rem] absolute top-[2.3rem] -left-4'><Image src="/images/about/share-sun.png" alt="no-img" fill className='max-sm:hidden object-contain'></Image></div>
