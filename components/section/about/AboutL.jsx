...
export default function AboutL({ ref }) {
  return (
    <div
      ref={ref}
      className="about-l relative z-20 translate-y-[4.6875rem] px-5 opacity-0 sm:px-20"
    >
      <div className="relative z-10 h-[7.42925rem] w-[20.098rem] shrink-0 sm:h-[22.1875rem] sm:w-[58.19256rem]">
        <Image src={'/images/about/h1.png'} alt="Hong Hao Travel" fill />
      </div>
      <div className="relative z-10 flex flex-col gap-[2.06rem] max-sm:mt-6">
        <p className="sub2-regular sm:body1-regular !text-greyscaletext-0 w-full sm:w-[52.3125rem]">
