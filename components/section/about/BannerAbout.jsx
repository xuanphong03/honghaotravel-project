...
export default function BannerAbout() {
  ...
  return (
    <div
      ref={about}
      className="about relative overflow-hidden pt-[7.25rem] max-sm:min-h-[56.6963rem] sm:py-[8.69rem]"
    >
      <OverlayAnimate />
      <div className="absolute top-0 right-0 left-0 h-full w-[101.5625rem]">
        <div
      ...
      <div className="absolute top-[15rem] right-0 z-10 h-[55.90219rem] max-h-full w-[27.522rem] sm:top-[15.5rem] sm:right-[8.55rem] sm:h-[85.19rem] sm:w-[56.58rem]">
        <div className="chu absolute top-[18rem] right-[1.6rem] z-20 flex items-end gap-[0.70rem] max-sm:flex-row-reverse sm:top-[35rem] sm:right-[1.25rem] sm:items-center sm:gap-20">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 animate-ping max-sm:mb-2"
            viewBox="0 0 20 20"
            fill="none"
          >
        ...
        <div className="absolute top-[27.85rem] z-20 flex gap-[3.14rem] max-sm:left-[6rem] max-sm:flex-col sm:top-[54.5rem] sm:right-[55rem] sm:items-center sm:gap-20">
          <AboutData
            ref={abd2}
      ...
      <div className="absolute top-[33.5rem] -right-[6.437rem] z-10 h-[10.74656rem] w-[25.36806rem] shrink-0 max-sm:hidden">
        <Image
