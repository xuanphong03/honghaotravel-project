...
export default function FAQQuestion() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="sub2-regular md:caption-regular !text-greyscaletext-80-main !text-xl !leading-[100%] !font-bold opacity-40">
          FAQS
        </p>
        <h2 className="h2-bold !text-greyscaletext-80-main max-md:!text-[2rem]">
          QUESTIONS ? LOOK HERE
        </h2>
      </div>
      <p
        ref={text2}
        className="body1-bold !text-greyscaletext-40 w-[38.8125rem] max-w-full translate-y-12 transform opacity-0 max-md:mb-[1.56rem]"
      >
        ...
        {Array.from({ length: 5 }).map((_, index) => (
          ...
          >
            <div className="flex h-full w-full flex-col justify-between">
              ...
              <p
                className={`sub2-medium ${ans && active === index ? 'translate-y-14 transform opacity-0' : ''} !text-greyscaletext-80-main !text-[2.75rem] duration-500 ease-in-out max-md:!text-[2rem]`}
              >
                What is excluded?
              </p>
            </div>
            ...
            >
              ...
              />
              <strong
                className={`sub2-medium !text-greyscaletext-80-main !text-[1.125rem]`}
              >
                What is excluded?
              </strong>
              <p
                className={`body1-regular !text-greyscaletext-40 overflow-y-scroll`}
              >
