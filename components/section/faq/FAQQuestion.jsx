...
export default function FAQQuestion() {
  ...
  return (
    <div ref={container} className="relative max-md:pt-8 md:py-16">
      ...
      <div className="mx-auto flex max-w-[87.5rem] flex-col max-md:px-3 md:gap-[3.56rem]">
        <div
          ref={text1}
          ...
          {Array.from({ length: 5 }).map((_, index) => (
            ...
            >
              ...
              >
                ...
                >
                  Included: Experienced tour guide Bike rentals (semi-automatic
                  or manual) Fuel for the bikes Accommodation (private rooms
                  available) Meals (breakfast, lunch, and dinner) Entrance fees
                  to attractions Protective gear (helmet, knee, and elbow pads)
                </p>
              </div>
            </div>
          ))}
