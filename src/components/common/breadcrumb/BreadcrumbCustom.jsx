...
export default function BreadcrumbCustom({ data = [] }) {
  return (
    <div className="hidden md:flex flex-col pt-[1.25rem] gap-[1.25rem] items-start">
      <div className="w-[87.5rem] mx-auto">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem className="text-[#C5C5C5] text-[0.875rem] tracking-[0.00219rem]">
              <BreadcrumbLink
                href="/"
            ...
            {data.map(({ page, to }, index) => {
              ...
              return (
                <React.Fragment key={index}>
                  ...
                  />
                  <BreadcrumbItem className="text-[0.875rem] tracking-[0.00219rem]">
                    <BreadcrumbLink
                      href={to}
                      className={`${
