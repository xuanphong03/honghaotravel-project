...
export default function WhatsAppButton() {
  return (
    ...
    >
      <span className="absolute top-1/2 left-1/2 inline-block size-[2.5rem] -translate-1/2 animate-ping rounded-full bg-white/15 blur-[0px] !duration-1000"></span>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 58 56"
        fill="none"
        className="absolute top-[-0.45rem] left-[0.4rem] size-[3.3rem] shrink-0"
      >
        <path
      ...
      <span className="absolute top-1/2 left-1/2 inline-block size-[3.125rem] -translate-1/2 rounded-full border-[0.35rem] border-solid border-white/15 blur-[0px]"></span>
    </Link>
  );
}
