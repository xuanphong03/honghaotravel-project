...
export default function NavigationItemV1({ title, to }) {
  return (
    <>
      <div className="group relative w-fit py-[0.5rem]">
        <Link
          href={to || "#"}
          className="inline-flex gap-[0.5rem] items-center text-white leading-[1.2] font-bold text-[2rem] group-hover:translate-x-[1.125rem] translate-x-0 transition-all duration-500"
        >
          {title}
        </Link>
        <svg
