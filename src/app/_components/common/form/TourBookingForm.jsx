...
import NumberFieldV2 from "../../form-controls/NumberFieldV2";
    ...
    <div className="relative bg-white !w-full rounded-[1.5rem]">
      <Form {...form}>
        <form
          ...
          className="flex max-h-[85vh] overflow-y-auto w-full max-md:flex-wrap max-md:gap-y-[4rem]"
        >
          <div className="w-full md:w-[34.75rem] flex flex-col gap-[1rem] shrink-0 md:py-[1.5rem] md:pl-[1.5rem] md:pr-[0.75rem]">
                    ...
                    <div className="relative">
                      <FormField
                        ...
                        render={({ field }) => {
                          ...
                          return (
                            <FormItem className="leading-[1.2] flex items-center gap-[0.25rem]">
                              <FormControl>
                                <Input
                                  readOnly
                                  {...field}
          ...
          <div className="w-full md:w-[35.5rem] flex flex-col gap-[0.75rem] shrink-0 md:py-[1.5rem] md:pr-[1.5rem] md:pl-[0.75rem]">
            <div className="text-[#262626]/40 max-md:text-[#262626] text-[0.875rem] font-bold leading-[1.2] tracking-[0.00875rem] uppercase">
