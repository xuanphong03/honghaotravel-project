...
export default function BlogContent() {
  return (
    ...
    >
      <div className="w-full md:w-[87.5rem] mx-auto flex flex-col items-center border-x border-solid border-gray-200">
        <div className="w-full max-md:px-[1rem] md:w-[65.6875rem] py-[1.875rem] md:pt-[5rem] md:pb-[5.33rem]">
          <h2 className="w-full text-[#313131] opacity-80 font-londrina-solid text-[1.5rem] tracking-[0.00375rem] font-black md:text-[3.5rem] leading-[1.2] mb-[1rem] md:mb-[3.56rem]">
          ...
          <div className="w-full flex flex-col gap-[1.5rem] md:gap-[2.5rem]">
            <div className="p-[1.25rem] flex flex-col gap-[0.625rem] md:gap-[1.875rem] bg-[#f1f1f1]">
              <h4 className="blog-sub-title !text-[#828282]">
                Table of Contents
              </h4>
              <ul className="px-[1.25rem] list-disc flex md:w-[63.34188rem] flex-col justify-center text-[0.875rem] font-bold tracking-[0.00875rem] leading-[1.2]">
                <li>
        ...
        <div className="flex items-center border-t border-solid border-gray-200 w-full">
          <div className="w-full max-md:pl-[1rem] md:w-[65.6875rem] h-[3.75rem] md:h-[5rem] mx-auto flex items-center gap-[1rem]">
            <div className="shrink-0 text-[#030922] text-[1rem] leading-[1.2] tracking-[0.0125rem]">
              Chia sẻ:
            </div>
            <ul className="flex items-center gap-[0.25rem] shrink-0">
              <li className="size-[2rem] shrink-0 flex items-center justify-center">
                <svg
