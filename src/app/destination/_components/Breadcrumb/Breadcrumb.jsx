...
export default function Breadcrumb() {
  return (
    <section className="bg-white overflow-hidden flex flex-col max-md:px-[1rem] gap-[1.25rem] py-[0.5rem] md:py-[1.25rem] border-b-[0.0625rem] border-solid border-[#f5f5f5]">
      <div className="flex items-center w-full md:w-[87.5rem] mx-auto gap-[0.5rem]">
        ...
        <Link
          href="/destination"
          className="inline-flex items-center gap-[0.25rem]"
        >
