...
export default function DiscoveryItem() {
  return (
    <article id="discovery_item" className="group relative w-full h-full">
      <Image
        alt="Hong Ha Travel"
        width={500}
        height={500}
      ...
      <div className="absolute top-[1.5rem] left-[1.5rem] z-[1]">
        <div className="overflow-hidden relative group-hover:bg-white/10 transition-colors duration-500 items-center justify-center rounded-[1.5rem] w-[9rem] h-[2.375rem] inline-flex bg-[rgba(255,53,11,0.70)] backdrop-blur-[16px]">
      ...
      <div className="absolute z-[1] left-[1.94rem] right-[1.94rem] bottom-[2.5rem] px-[1rem] py-[1.5rem] inline-flex flex-col group-hover:gap-[1rem] rounded-[1.5rem] bg-white/15 backdrop-blur-[16px]">
        <div className="flex items-center justify-between w-full">
          <span className="uppercase text-[1.5rem] font-extrabold leading-[1.2] text-white">
            Dong van
          </span>
          <div className="size-[2rem] flex items-center justify-center arrow_animation">
            <Image
              alt="Hong Ha Travel"
              width={20}
              height={20}
        ...
        <p className="group-hover:h-[6rem] duration-500 ease-in transition-all line-clamp-4 h-0 md:w-[23.5625rem] text-white text-base not-italic font-normal leading-[150%] tracking-[0.005rem]">
          ...
          enim eum, beatae autem veniam consequuntur sit ab ea ipsam dolorem
          voluptas! Aut nesciunt quibusdam qui accusantium id quidem esse fuga.
        </p>
      </div>
    </article>
  );
